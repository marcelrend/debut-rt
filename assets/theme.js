...
slate.Variants = (function() {
  ...
  Variants.prototype = _.assignIn({}, Variants.prototype, {
    ...
    /* Custom trigger */
    _updateName: function(variant) {
      this.$container.trigger({
        type: 'variantNameChange',
        variant: variant
      });
    },
  ...
  function renderProductDetails(product) {
    return [
      '<dl class="predictive-search-item__details price' +
        ...
        (!product.available ? ' price--sold-out' : ' price-stock') +
...
theme.Product = (function() {
  function Product(container) {
    ...
    this.selectors = {
      ...
      variantsInStock: '[variants-in-stock]',
      name: '[data-name]',
      SKU: '.variant-sku',
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _initVariants: function() {
      ...
      // Ugly custom method to init availability
      var prod = {
    ...
    /* Custom trigger */
    _updateNameSelf: function(evt) {
      $(this.selectors.name).html(evt.variant.name);
    },
    ...
    _updatePrice: function(evt) {
      ...
      $priceContainer
        ...
        .removeClass(this.classes.productStock)
        .removeAttr('aria-hidden');
      ...
      if (!variant.available) {
        ...
        $priceContainer.addClass(this.classes.productStock);
      }
